...
########################################################################## Labels
label1 = Label(root,text='Enter Words : ',font=('times',15,'italic bold'),bg='lightblue')
label1.place(x=5,y=40)

label2 = Label(root,text='Translated : ',font=('times',15,'italic bold'),bg='lightblue')
label2.place(x=5,y=100)

label3 = Label(root,text=' ',font=('times',15,'italic bold'),bg='lightblue')
label3.place(x=10,y=250)

############################################################################ Buttons
btn1 = Button(root,text='Translate',bd=10,bg='white',activebackground='brown',width=10,font=('times',15,'italic bold'),
              command=tt)
btn1.place(x=70,y=170)

btn2 = Button(root,text='Exit',bd=10,bg='white',activebackground='brown',width=10,font=('times',15,'italic bold'),
              command=main_exit)
